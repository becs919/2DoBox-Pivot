...
$('.bottom-container').on('click', '.completed-task', function(){
  ...
  //
  // if ($(this).closest('.todo-section').hasClass('.strike-through')){
  //   localStorage.setItem(id, JSON.stringify(todo));
  // }
...
//Create 5 buttons corresponding to each level of importance
//When one of the filter buttons is clicked the todo list should only show the selected todo's
//CHARACTER Counter
