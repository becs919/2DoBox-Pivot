...
$(document).ready(() => {
  let sortedArray = Object.keys(localStorage).sort(function(key) {
   return JSON.parse(localStorage[key]).complete? 0 : 1;
  })

  sortedArray.map(function(key){
